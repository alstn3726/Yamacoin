...
#if defined(NDEBUG)
# error "YAMAcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "YAMAcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s YAMA additional fees, %d delta bytes\n",
