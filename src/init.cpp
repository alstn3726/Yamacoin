...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/yamacoin-project/yamacoin>";
    const std::string URL_WEBSITE = "<https://yamacoin.org>";
