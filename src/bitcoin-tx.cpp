...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s yamacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yamacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yamacoin transaction") + "\n" +
              "  yamacoin-tx [options] -create [commands]   " + _("Create hex-encoded yamacoin transaction") + "\n" +
              "\n";
