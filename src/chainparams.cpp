...
{
    const char* pszTimestamp = "pil min su hyun 's first Yama Coin";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2.8 * 24 * 60 * 60; // 3.5 days
        ...
        genesis = CreateGenesisBlock(1623930425, 521828, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc541a8f77e938e458a2891869365c710e9f7721733713081c7c25e804a6e3a9d"));
        assert(genesis.hashMerkleRoot == uint256S("0x88479017a15881bda60415e9a8362b2741af4d54edb64edff44790f9b83402af"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.yamacoin.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.yamacointools.com", true);
        // vSeeds.emplace_back("dnsseed.yamacoinpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0xc541a8f77e938e458a2891869365c710e9f7721733713081c7c25e804a6e3a9d")}
        ...
        chainTxData = ChainTxData{
            ...
            1623930425, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1623932691, 2917094, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf4ae7aa0e8a3ca0a60e7f336232b6e7c3f6459d8bd701dc7a45ecc94bf7daa7f"));
        assert(genesis.hashMerkleRoot == uint256S("0x88479017a15881bda60415e9a8362b2741af4d54edb64edff44790f9b83402af"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // vSeeds.emplace_back("testnet-seed.yamacointools.com", true);
        // vSeeds.emplace_back("seed-b.yamacoin.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("f4ae7aa0e8a3ca0a60e7f336232b6e7c3f6459d8bd701dc7a45ecc94bf7daa7f")},
            }
        };
